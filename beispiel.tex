...
\begin{figure}[htb]
 \centering
 \includegraphics[width=0.4\textwidth,angle=45]{abbildungen/feulogo}
 \caption[Beispiel einer Bildbeschreibung]{Beispiel einer Bildbeschreibung}
\label{fig:beispiel1}
\end{figure}
...
\begin{figure}[htb]
 \centering
 \includegraphics[width=0.3\textwidth,angle=0]{abbildungen/feulogo}
